            ...
            {games.map((game) => {
              ...
              return (
                <tr key={game.id}>
                  ...
                  <td>
                    <span
                      className={`${styles.badge} ${game.removed ? styles.removed : game.owned ? styles.owned : styles.wishlist}`}
                    >
                  ...
                  <td className={styles.sessions}>{last ? formatDate(last.date) : "—"}</td>
                  <td className={styles.sessions}>{last?.notes ?? "—"}</td>
                </tr>
              );
            })}
          </tbody>
